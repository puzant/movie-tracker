...
const Login = ({ loginUser, success, error }: LoginProps) => {
  ...
  return (
    <Root>
      ...
      <NoticeText>
        This app gets its data from the TMDD APIs. To view your account
      ...
      {error && (
        <Alert severity="error">An error occured while trying to login</Alert>
      )}
