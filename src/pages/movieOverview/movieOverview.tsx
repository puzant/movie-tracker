...
export const MovieOverview = ({
  ...
  const actors: Actor[] =
    movie.credits?.cast?.slice(0, MAX_NUMBER_OF_ACTORS) ?? [];
          ...
          <MovieDescriptionContainer>
            <BlockGroup>
              ...
              <Block gap={10}>
                ...
                <MovieInfo
                  text="Language"
                  value={utils.getMovieLanguage(movie.original_language)}
                />
...
const MovieOverviewContainer = styled.div<{
  ...
  background: ${(props) =>
    `url(https://image.tmdb.org/t/p/w1280/${props.backdropPath})`};
